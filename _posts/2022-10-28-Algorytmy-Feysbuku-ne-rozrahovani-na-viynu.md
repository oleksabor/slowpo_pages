...
І у користувачів фейсбуку є вихід - інтернету все ще багато, площадок для хостінгу - теж.
Але зібратись гуртом і звалити - це треба дуже сінхронно робити, а сінхронно не вийде, бо це буде знову площадка, де правила буде встановлювати хазяїн.

І проблема правил в приватній соцмережі вступає у двобій зі зручностю кнопки _лайк_.
От і виходить, що в пошуках кнопки лайк пересічні шукають вихід - а знайти не можуть.
Бо хазяїн кнопки встановлює правила а не пересічний натискач.
І хазяїн - встановлює правила.
...
- сайти, що дозволяють розміщувати статичні веб сторінки безкоштовно.
  Vercel наприклад.
- rss feed як засіб повідомляти світ про свої новини.
...
- перетворювач .md до html.
  Такий як Jekyll.
  
Далі залишається суто технічне питання: написані руками .md файли зібрати докупи, скласти окремо у вигляді html і завантажити в інтернет, де вони і будуть доступні всім бажаючим.

В результаті всі тексти будуть збережені у автора і тільки виставлені назовню для загального користування.
Біда тільки - відосіки потребують окремого хостінгу.
...
Чи його змістять конкуренти (google+ що не злетів чи Sl8 що намагається просунути кріпту).
Але будуть мережі і будуть правила.
